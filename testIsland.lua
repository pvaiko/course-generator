...
-- x | x x x x | x x
-- 1 2 3 4 5 6 7 8 9
assertEquals( #course, 9 )
assertEquals( course[ 2 ].x , -23 )
assertEquals( course[ 7 ].x , 23 )
...
-- x | x x | x x
-- 1 2 3 4 5 6 7
assertEquals( #course, 7 )
assertEquals( course[ 2 ].x , -23 )
assertEquals( course[ 5 ].x , 23 )
...
assertEquals( course[ 2 ].x , -23 )
assertEquals( course[ 4 ].x , -8 )
assertEquals( course[ 5 ].x , -8 )
assertEquals( course[ 7 ].x , -8 )
